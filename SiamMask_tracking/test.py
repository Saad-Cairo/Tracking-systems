...
sys.path.insert(1, str(pathlib.Path(__file__).parent.parent.absolute())+'/utils')
...
sys.path.insert(1, str(pathlib.Path(__file__).parent.parent.absolute())+'/utils/pyvotkit')
